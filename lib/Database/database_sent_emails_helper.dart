...
class DatabaseSentEmailsHelper{

  static const _dbName = 'SentDatabase.db';
  ...
  DatabaseSentEmailsHelper._privateConstructor();
  static final DatabaseSentEmailsHelper instance = DatabaseSentEmailsHelper._privateConstructor();
